        ...
        <div className={"flex flex-col items-center justify-center min-h-screen"}>
            <div className={"flex flex-col items-center justify-center rounded-8 p-10"}>
                ...
                <form onSubmit={handleRegister} className={"flex flex-col items-center justify-center"}>
                    ...
                    <button type="submit"
                            className={"btn px-6 mt-4 btn-sm bg-primary-light border-0 text-white dark:bg-primary-dark dark:hover:bg-primary-dark rounded-8 font-semibold hover:scale-105 transition hover:bg-primary-dark"}>Register
                    </button>
                </form>
                <a href={"/login"} className={"mt-5 link text-primary-light dark:text-white text-xs"}>Already have an
                    account?
                    Log in here!</a>
            </div>
        </div>
