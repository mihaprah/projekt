...
const Login = () => {
    ...
    return (
        <div className={"flex flex-col items-center justify-center"}>
            ...
            <h1 className={"text-xl font-bold mb-5"}>Log in with Mail</h1>
            <form onSubmit={handleLogin} className={"flex flex-col items-center justify-center"}>
                ...
                <button type="submit"
                        className={"btn btn-sm btn-outline w-20 rounded-8 text-primary-light font-bold hover:bg-primary-light"}>Log in
                </button>
            </form>
            <a href={"/register"} className={"link text-primary-light text-xs mt-2"}>Do not have an account? Register here!</a>
        </div>
